...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("Source Code 🍃", url="https://t.me/NOOBPV_BOT?start=Y29weV8tMTAwMjIxMzEzMDM2Nl8xMzk0XzEzOTQ=")]]), reply_to_message_id=message.id)
